    ...
    <footer className="bg-gray-900 text-gray-400 pt-20 pb-8">
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {/* Address */}
          <div className={`flex items-start ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-700`} style={{ transitionDelay: '0.3s' }}>
            ...
            <div>
              ...
              <h3 className="text-white text-lg font-medium">International Tech Park, Bengaluru</h3>
            </div>
          </div>

          {/* Email */}
          <div className={`flex items-start ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-700`} style={{ transitionDelay: '0.5s' }}>
            <div className="bg-blue-100 p-3 rounded-lg mr-4">
            ...
            <div>
              ...
              <h3 className="text-white text-lg font-medium">
                <a href="mailto:support@codenexaonline.com" className="hover:text-blue-400 transition-colors">support@codenexaonline.com</a>
              </h3>
            </div>
          </div>

          {/* Phone */}
          <div className={`flex items-start ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-700`} style={{ transitionDelay: '0.7s' }}>
            <div className="bg-blue-100 p-3 rounded-lg mr-4">
              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <div>
              ...
              <h3 className="text-white text-lg font-medium">
                <a href="tel:+918840531793" className="hover:text-blue-400 transition-colors">+91 8840531793</a>
              </h3>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Company Info */}
          <div className={`${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-700`} style={{ transitionDelay: '0.3s' }}>
            <div className="mb-6">
              <a href="#" className="text-2xl font-bold text-white flex items-center">
                <span className="bg-blue-600 text-white p-2 rounded mr-2">CG</span>
                CodeGemi
              </a>
            </div>
            <p className="mb-6 text-gray-400">
              CodeGemi IT is where technology meets precision - delivering ultricies aliquam 
              volutpat and solutions that blend modern agility with laoreet-driven excellence.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-white hover:bg-blue-600 transition-colors">
                <i className="fab fa-facebook-f"></i>
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-white hover:bg-blue-400 transition-colors">
                <i className="fab fa-twitter"></i>
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-white hover:bg-red-600 transition-colors">
                <i className="fab fa-youtube"></i>
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-white hover:bg-pink-600 transition-colors">
          ...
          {/* Quick Links */}
          <div className={`${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-700`} style={{ transitionDelay: '0.5s' }}>
            <h3 className="text-lg font-semibold text-white mb-6">Quick Links</h3>
            <ul className="space-y-3">
              <li><a href="#" className="flex items-center text-gray-400 hover:text-white transition-colors"><span className="w-2 h-2 bg-blue-600 rounded-full mr-2"></span>CodeGemi About</a></li>
              <li><a href="#" className="flex items-center text-gray-400 hover:text-white transition-colors"><span className="w-2 h-2 bg-blue-600 rounded-full mr-2"></span>Our Services</a></li>
              <li><a href="#" className="flex items-center text-gray-400 hover:text-white transition-colors"><span className="w-2 h-2 bg-blue-600 rounded-full mr-2"></span>Our Blogs</a></li>
              <li><a href="#" className="flex items-center text-gray-400 hover:text-white transition-colors"><span className="w-2 h-2 bg-blue-600 rounded-full mr-2"></span>FAQ's</a></li>
              <li><a href="#" className="flex items-center text-gray-400 hover:text-white transition-colors"><span className="w-2 h-2 bg-blue-600 rounded-full mr-2"></span>Contact Us</a></li>
            </ul>
          </div>

          {/* Recent Posts */}
          <div className={`${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-700`} style={{ transitionDelay: '0.7s' }}>
          ...
          {/* Contact & Newsletter */}
          <div className={`${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-700`} style={{ transitionDelay: '0.9s' }}>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-white">support@codenexaonline.com</span>
              </div>
              <div className="flex items-center">
                <div className="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center mr-3">
                  <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="mt-6">
              <div className="relative flex items-center bg-gray-800 rounded-lg overflow-hidden">
                ...
                />
                <button 
                  className={`p-3 ${email && agree ? 'bg-blue-600 hover:bg-blue-700' : 'bg-gray-700'} text-white transition-colors`}
              ...
              <div className="mt-4 flex items-start">
                ...
                />
                <label htmlFor="agreeCheckbox" className="text-sm text-gray-400">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="#" className="text-sm text-gray-400 hover:text-white transition-colors">Terms & Condition</a>
