    ...
    <div className="font-sans overflow-hidden">
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1510&q=80')" }}
        ></div>
        ...
        <div className={`container mx-auto px-4 relative z-10 text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 animate-fade-in-down">
            Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-pink-500">Services</span>
          </h1>
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center mb-4 px-4 py-2 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full shadow-md">
              ...
              <span className="text-sm font-semibold tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-pink-500 uppercase">OUR SERVICES</span>
              <div className="h-px w-8 bg-gradient-to-r from-orange-500 to-pink-500 ml-2"></div>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">We Provide <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Premium</span> Solutions</h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">Our comprehensive suite of services is designed to help your business thrive in the digital age with innovative and tailored approaches.</p>
          </div>
                ...
                <div className="relative z-10">
                  <div className="mb-6 flex justify-center">
                    <div className="h-20 w-20 bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl flex items-center justify-center group-hover:from-blue-500 group-hover:to-purple-600 transition-all duration-500 group-hover:rotate-12 transform group-hover:scale-110">
                      <img src={service.icon} alt={service.title} className="h-10 w-10 group-hover:filter group-hover:invert transition-all duration-500" />
                    </div>
                  </div>
                  <div className="text-center">
                    <h4 className="text-xl font-semibold mb-4">
                      <a href="/service-details" className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-purple-700 hover:from-orange-500 hover:to-pink-500 transition-all duration-300 relative inline-block">
                        {service.title}
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 text-white relative overflow-hidden">
        ...
        <div className="absolute -top-20 -left-20 w-64 h-64 bg-white/5 rounded-full animate-ping-slow" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-10 right-10 w-40 h-40 bg-orange-500/10 rounded-full animate-pulse"></div>
        <div className="absolute top-1/2 left-1/4 w-32 h-32 bg-blue-400/10 rounded-full animate-bounce-slow" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-5xl md:text-6xl font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-pink-400">{stat.value}</div>
                <div className="text-sm uppercase tracking-wider font-medium bg-white/10 py-2 px-4 rounded-full backdrop-blur-sm">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2">
              <div className="mb-12">
                <div className="inline-flex items-center mb-4 px-4 py-2 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full shadow-md">
                  <div className="h-px w-8 bg-gradient-to-r from-orange-500 to-pink-500 mr-2"></div>
                  <span className="text-sm font-semibold tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-pink-500 uppercase">Frequently Asked Questions</span>
                  <div className="h-px w-8 bg-gradient-to-r from-orange-500 to-pink-500 ml-2"></div>
                </div>
                <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
                  Answers to Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Questions</span>
                </h2>
                <p className="text-gray-600 text-lg">
                  We've compiled a list of common questions to help you understand our services better.
                </p>
              </div>
                ...
                {faqs.map((faq, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <svg 
                        className={`w-6 h-6 transition-transform duration-300 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 ${activeFaq === index ? 'transform rotate-180' : ''}`} 
                        fill="none" 
                        stroke="currentColor" 
                        viewBox="0 0 24 24"
                      >
                    ...
                    <div 
                      className={`overflow-hidden transition-all duration-500 ${activeFaq === index ? 'max-h-96' : 'max-h-0'}`}
                    >
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-indigo-900 via-blue-800 to-purple-900 text-white relative overflow-hidden">
        ...
        <div className="absolute -top-20 -right-20 w-56 h-56 bg-orange-500/10 rounded-full animate-ping-slow" style={{ animationDelay: '1s' }}></div>
            ...
            <div className="lg:w-1/2">
              <div className="mb-12">
                <div className="inline-flex items-center mb-4 px-4 py-2 bg-white/10 rounded-full backdrop-blur-sm">
                  ...
                  <span className="text-sm font-semibold tracking-wider uppercase">TALK TO US</span>
                  <div className="h-px w-8 bg-white ml-2"></div>
                </div>
                <h2 className="text-4xl md:text-5xl font-bold mb-6">How Can We <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-pink-400">Help You?</span></h2>
...
const faqs = [
  {
    ...
    answer: "Project timelines vary based on complexity, but most of our software projects range from 3-9 months. We provide detailed timelines after our initial consultation and requirements gathering phase."
  },
  {
    question: "What is included in your digital marketing services?",
    answer: "Our digital marketing package includes SEO optimization, content strategy, social media management, PPC advertising, email marketing campaigns, and comprehensive analytics reporting."
  },
  {
    question: "Do you provide ongoing support after project completion?",
    answer: "Yes, we offer various support packages tailored to your needs, including regular maintenance, updates, troubleshooting, and 24/7 emergency support options."
  },
  {
    question: "Can you work with our existing technology stack?",
    answer: "Absolutely. Our team is experienced with a wide range of technologies and we can integrate with your existing systems or recommend improvements where needed."
  }
];
